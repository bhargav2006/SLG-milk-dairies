    ...
    <div className="login-page-container">
      ...
      <div className="login-card" style={{ maxWidth: "460px" }}>
        <div className="login-logo-section">
          ...
          >
            <img src="/logo.png" alt="SRI LAKSHMI GANAPATHI MILK DAIRYS Logo" style={{ width: "100%", height: "100%", objectFit: "contain" }} />
          </div>
          <h1 className="brand-name" style={{ fontSize: "1.75rem", textAlign: "center" }}>
            Create Account
          </h1>
          <p className="login-subtitle">SRI LAKSHMI GANAPATHI MILK DAIRYS (Visakha Dairy Partner)</p>
        </div>
