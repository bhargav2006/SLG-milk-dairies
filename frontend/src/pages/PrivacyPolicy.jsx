      ...
      <header className="privacy-header-nav">
        <div className="privacy-brand">
          ...
          <div className="privacy-brand-text">
            <span className="privacy-brand-name">SRI LAKSHMI GANAPATHI MILK DAIRYS</span>
      ...
      <main className="privacy-card-wrapper">
        <section className="privacy-hero-banner">
          ...
          <p className="privacy-hero-desc">
            We value your trust. This Privacy Policy explains how SRI LAKSHMI GANAPATHI MILK DAIRYS collects, uses, and safeguards information when you visit our website, use our billing portal, or contact us.
          </p>
