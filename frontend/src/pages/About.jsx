      ...
      >
        <div className="lp-container lp-hero-container">
          <div className="lp-hero-content">
            <span className="lp-badge lp-hero-badge">
            ...
            <p className="lp-hero-desc">
              SRI LAKSHMI GANAPATHI MILK DAIRYS, in proud partnership
          ...
          <div className="lp-hero-card-wrapper">
            <div className="lp-glass-card">
              ...
              <p>
                Proudly distributing products for <strong>Visakha Dairy</strong>
                , India's leading dairy co-operative union.
              </p>
            </div>
            <div className="lp-glass-card">
              <div className="lp-card-icon">
              ...
              <p>
                Serving residential homes, hotels, restaurants, and retail
                partners daily with cold-chain delivery.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="lp-container">
          ...
          <div className="lp-grid lp-grid-2">
            <div>
              ...
              <p>
                SRI LAKSHMI GANAPATHI MILK DAIRYS (Visakha Dairy
                ...
                based on trust, purity, and absolute commitment to quality.
              </p>
              <p>
                We source fresh milk directly from hygienic farms, subjected to
                rigorous quality tests before cooling and packaging. As a
                premium distributor for Visakha Dairy, we offer a diverse
                catalog of dairy products ranging from standard pasteurized milk
                to premium ghee, paneer, and sweets.
              </p>
              ...
              <ul className="lp-about-features">
                <li>
                  ...
                  <span>
                    State-of-the-art cold storage facility keeping dairy fresh.
                  </span>
                </li>
                <li>
                  <CheckCircle className="lp-feat-icon" size={20} />
                  <span>
                    Direct partnership with Visakha Dairy for genuine products.
                  </span>
                </li>
                <li>
                  <CheckCircle className="lp-feat-icon" size={20} />
                  <span>
                    Strict quality testing for fat content, purity, and hygiene.
                  </span>
                </li>
              </ul>
            </div>
          ...
          <div className="lp-verification-card">
            ...
            <div className="lp-verification-grid">
              ...
              <div className="lp-v-item lp-v-span-2">
                ...
                <div className="lp-v-value lp-locations-list">
                  <div>
                    <strong>
                      Official Registered Address (as per Udyam Certificate):
                    </strong>
                    <br />D NO 5-57/3, Main Road, Patha Gannavaram,
                    P.Gannavaram, East Godavari District, Andhra Pradesh -
                    533240, India
                  </div>
                  <div
                    style={{
            ...
            {/*<div className="lp-verification-footer-note">
              ...
              <span>
                ...
                Meta Verification. For document uploads, refer to our Udyam Registration Certificate (UDYAM-AP-03-0012683 under the name SRI LAKSHMI GANAPATHI MILK DAIRYS), Partnership Agreement, Municipal
        ...
        <div className="lp-container">
          ...
          <div className="lp-grid lp-grid-3">
            <div className="lp-service-card">
              ...
              <p>
                We supply premium Visakha Milk in bulk quantities to hotels,
                restaurants, sweet manufacturers, and retail shops with early
            ...
            <div className="lp-service-card">
              ...
              <p>
                Equipped with cooling chambers and insulated logistics, we
                ensure the milk and dairy products remain under 4°C from
            ...
            <div className="lp-service-card">
              ...
              <p>
                Our outlets at P.Gannavaram and Pothavaram offer
                direct-to-consumer sales for milk, curd, ghee, paneer, and
                delicious milk sweets.
              </p>
            </div>
            <div className="lp-service-card">
              <div className="lp-service-icon">
              ...
              <p>
                We work directly with local farmers in East Godavari,
                facilitating prompt payments and supporting the rural dairy
                farming community.
              </p>
            </div>
            <div className="lp-service-card">
              ...
              <p>
                Every batch of milk undergoes thorough chemical testing for fat,
                SNF (Solid-Not-Fat), and water adulteration prior to
                distribution.
              </p>
            </div>
            <div className="lp-service-card">
              ...
              <p>
                Planning a wedding or festival? We provide specialized bulk
                catering supply of fresh curd, milk, and paneer at special
                wholesale pricing.
              </p>
            </div>
          </div>
      ...
      <section id="products" className="lp-section-padding lp-bg-light">
        <div className="lp-container">
          <div className="lp-section-header lp-text-center">
            ...
            <p className="lp-section-header-desc">
              We offer the full range of fresh, healthy, and premium quality
              dairy foods.
            </p>
            <div className="lp-title-underline"></div>
          </div>
          ...
          <div className="lp-grid lp-grid-3">
            {productsList
              .filter(
                (prod) =>
                  activeFilter === "all" || prod.category === activeFilter,
              )
              .map((product, index) => (
        ...
        <div className="lp-container">
          ...
          <div className="lp-faq-container">
            {[
              ...
              <div
                className={`lp-faq-item ${activeFaq === i ? "active" : ""}`}
                key={i}
              >
                <button
          ...
          <div className="lp-grid lp-grid-2">
            <div className="lp-contact-info-wrapper">
              ...
              <p className="lp-contact-intro">
                Feel free to call, email, or visit our facilities. Our manager,
                Manikonda Swamy, and team will assist you with any supply
                requirements.
              </p>
              ...
              <div className="lp-contact-details-list">
                <div className="lp-contact-detail-item">
                  ...
                  <div>
                    ...
                    <p>
                      <a
                        href="tel:+919966675377"
                        className="lp-text-light-link"
                      >
                        +91 99666 75377
                      </a>
                    </p>
                ...
                <div className="lp-contact-detail-item">
                  ...
                  <div>
                    ...
                    <p>
                      <a
                        href="mailto:yerramsettidurgarao435@gmail.com"
                        className="lp-text-light-link"
                      >
                        yerramsettidurgarao435@gmail.com
                      </a>
              ...
              <form onSubmit={handleContactSubmit} className="lp-contact-form">
                ...
                <div className="lp-form-group">
                  ...
                  <select id="formSubject" className="lp-form-control">
                    ...
                    <option value="Retail Booking">
                      Retail Bulk Booking (Events)
                    </option>
      ...
      <footer className="lp-main-footer">
        <div className="lp-container lp-footer-content lp-text-center">
          <div className="lp-footer-logo">
            ...
            />
            <h3>SRI LAKSHMI GANAPATHI MILK DAIRYS</h3>
          ...
          <div className="lp-footer-bottom">
            <p>
              &copy; 2026 SRI LAKSHMI GANAPATHI MILK DAIRYS. All rights
              reserved.
            </p>
            <p className="lp-coop-disclaimer">
              Partnered with Visakha Dairy (Sri Vijaya Visakha District Milk
              Producers Mutually Aided Cooperative Union Ltd.)
            </p>
          </div>
        </div>
      </footer>
