...
const MainLayout = ({ children }) => {
  ...
  const getPageTitle = () => {
    ...
    return "SRI LAKSHMI GANAPATI MILKS VISAKHA DAIRY System";
  };
      ...
      >
        <div className="sidebar-brand">
          <div className="sidebar-logo">
            <img src="/logo.png" alt="SRI LAKSHMI GANAPATI MILKS VISAKHA DAIRY Logo" style={{ width: "28px", height: "28px", objectFit: "contain", borderRadius: "50%" }} />
          </div>
          <span className="brand-name" style={{ fontSize: "0.8rem", whiteSpace: "normal", lineHeight: "1.2" }}>SRI LAKSHMI GANAPATI MILKS VISAKHA DAIRY</span>
        </div>
